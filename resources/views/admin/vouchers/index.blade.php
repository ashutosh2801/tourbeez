<x-admin>
    ...
    <!-- SEARCH BOX -->
    <div class="voucher-list-body mb-3">
        <div class="card bg-white border rounded-lg-custom">
            <form action="{{ route('admin.vouchers.index') }}" method="get">
                    ...
                    <div class="search-options">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <a href="{{ route('admin.vouchers.index') }}" class="btn-clear"> <i class="fas fa-times"></i> Clear Search</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <div class="card-tools btn-options w-100">
                            <a href="" class="btn btn-export">
                                <i class="fas fa-file-import"></i> Export to CSV
                            </a>
                            <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure to delete all?')">
