      ...
      <div class="col-12 col-lg-9 col-xl-8 col-xxl-7">
        <div class="row gy-3 mb-3">
          ...
          <div class="col-6">
            <a class="d-block text-end" href="#!">
              <img src="https://tourbeez.com/tbadmin/public/admin/dist/img/tourbeez-logo.png" class="img-fluid" alt="BootstrapBrain Logo" width="135" height="44">
            </a>
          </div>
          <div class="col-12">
            <h4>From</h4>
        ...
        <div class="row">
          <div class="col-12 text-end">
            <button class="btn btn-primary mb-3" onclick="downloadInvoicePDF()">Download Invoice</button>
