                    ...
                    <!-- <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="image" id="image" class="form-control" accept="image/*"
                                >
                                @php
                                $image_path = public_path('tour-image/' . $data->main_image?->image);
                                if (file_exists($image_path)) {
                                    $filename = asset('tour-image/' . $data->main_image?->image);
                                    echo '<a target="_blank" href="'. $filename .'"><img src="'. $filename .'" height="100" /></a>';
                                }
                                @endphp
                            @error('image')
                                <small class="form-text text-danger">{{ $message }}</small>
