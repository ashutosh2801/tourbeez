    ...
    <div class="card-info">
        ...
        <form class="needs-validation" novalidate action="{{ route('admin.tour.notification_update', $data->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-footer" style="display:block">                
                <a style="padding:0.6rem 2rem" href="{{ route('admin.tour.edit.gallery', encrypt($data->id)) }}" class="btn btn-secondary">Back</a>
                <button style="padding:0.6rem 2rem" type="submit" id="submit" class="btn btn-success">Save</button>
                <a style="padding:0.6rem 2rem" href="{{ route('admin.tour.edit.message.reminder', encrypt($data->id)) }}" class="btn btn-primary">Next</a>   
            </div>
        </form>
    </div>
</div>
