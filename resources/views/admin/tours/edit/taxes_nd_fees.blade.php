...
<div class="card">
    <div class="card card-primary">
        ...
        <form class="needs-validation" novalidate action="{{ route('admin.tour.taxfee_update', $data->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="text-left">
              <a href="{{ route('admin.taxes.create') }}" class="btn btn-success"> + Add New Taxes and Fees</a>
            </div>
          </div>
          <div class="card-footer" style="display:block">
            <div class="row">
              ...
              <div class="col-md-6 align-buttons">
                <a style="padding:0.6rem 2rem" href="{{ route('admin.tour.edit.exclusions', encrypt($data->id)) }}" class="btn btn-secondary"> <i class="fas fa-chevron-left"></i> Back</a>
                <a style="padding:0.6rem 2rem" href="{{ route('admin.tour.edit.gallery', encrypt($data->id)) }}" class="btn btn-secondary">Next <i class="fas fa-chevron-right"></i></a>
              </div>
            </div>
          </div>
        </form>
