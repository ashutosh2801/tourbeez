<x-admin>
    @section('title','Edit Tour - Partner')
    @section('css')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link active" href="{{ route('admin.tour.edit.partner', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Partner')}}</a>                               
                        ...
                        <div class="col-10">
                            <div class="tab-content" id="v-pills-tabContent">                                
                                <div class="tab-pane fade show active" id="location" role="tabpanel" aria-labelledby="v-pills-messages-tab-4">
                                    <div class="card">
                                        @include('admin.tours.edit.partner')
                                    </div>
                                </div>
                            </div>
                        </div>
