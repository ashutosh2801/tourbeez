                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 pr-0 desktop-menu">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link" href="{{ route('admin.tour.edit.review', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Review')}}</a>
                                <a class="nav-link" href="{{ route('admin.tour.edit.parent', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Parent Tour')}}</a>
                                <a class="nav-link active" href="{{ route('admin.tour.edit.schedule-pricing', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Schedule Pricing')}}</a>                                 
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-9 col-12 pl-0">
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="faq" role="tabpanel" aria-labelledby="v-pills-messages-tab-7">
                                    <div class="card faq-body">
                                        @include('admin.tours.edit.schedule-pricing')
                                    </div>
                                </div>
                            </div>
                        </div>
