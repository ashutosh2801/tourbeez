                        ...
                        <div class="col-md-10 col-12 pl-0">
                            <div class="tab-content" id="v-pills-tabContent">                                
                                <div class="tab-pane fade show active" id="message" role="tabpanel" aria-labelledby="v-pills-messages-tab-12">
                                    <div class="card PaymentRequest-body">
                                        <div class="PaymentRequest-nav nav nav-pills mb-2 justify-center align-center" id="v-pills-tab" role="tablist" aria-orientation="horizontal">
                                            ...
                                            <a class="nav-link" href="{{ route('admin.tour.edit.message.followup', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Followups')}}</a>
                                            <a class="nav-link active" href="{{ route('admin.tour.edit.message.paymentrequest', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Payment Request')}}</a>
                                        </div>

                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active" id="paymentrequest" role="tabpanel" aria-labelledby="v-pills-tab-100">
