                        ...
                        <div class="col-md-10 col-12 pl-0">
                            <div class="tab-content" id="v-pills-tabContent">                                
                                <div class="tab-pane fade show active" id="message" role="tabpanel" aria-labelledby="v-pills-messages-tab-12">
                                    <div class="card reminder-body">
                                        <div class="reminder-nav nav nav-pills mb-2 justify-center align-center" id="v-pills-tab" role="tablist" aria-orientation="horizontal">
                                            ...
                                            <a class="nav-link active" href="{{ route('admin.tour.edit.message.reminder', encrypt($data->id)) }}"><i class="fas fa-caret-right"></i> {{translate('Remiders')}}</a>
