                    ...
                    <div class="row">
                        <div class="card-body col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    type="text"
                                    class="form-control @error('Voucher.code') is-invalid @enderror"
                                    name="Voucher[code]"
                                    id="Voucher_code"
                                    placeholder="Enter promo code"
                                    value="{{ old('Voucher.code') }}"
                                    required
                                ...
                                @enderror
                                <div class="invalid-feedback d-none" id="err_Voucher_code">Promo code is required.</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                >
                                    <option value="ISSUED" {{ old('Voucher.status') == 'ISSUED' ? 'selected' : '' }}>Issued</option>
                                    <option value="EXPIRED" {{ old('Voucher.status') == 'EXPIRED' ? 'selected' : '' }}>Expired</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select
                                    class="form-control"
                                    name="Voucher[quantityRule]"
                                    id="Voucher_quantityRule"
                                    data-help="help_quantity_rule"
                                >
                                    <option value="ORDER" {{ old('Voucher.quantityRule') == 'ORDER' ? 'selected' : '' }}>Order</option>
                                    <option value="PRODUCT" {{ old('Voucher.quantityRule') == 'PRODUCT' ? 'selected' : '' }}>Product</option>
                                    <option value="QUANTITY" {{ old('Voucher.quantityRule') == 'QUANTITY' ? 'selected' : '' }}>Quantity</option>
                                </select>
                            </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group date form_date">
                                        ...
                                        <input
                                            ...
                                            name="Voucher[issueDate]"
                                            id="Voucher_issueDate"
                                            placeholder="Select Date"
                                            data-single="true"
                                            data-show-dropdown="true"
                                            value="{{ old('Voucher.issueDate') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group date form_date">
                                        ...
                                        <input
                                            type="text"
                                            class="aiz-date-range form-control"
                                            name="Voucher[expiryDate]"
                                            id="Voucher_expiryDate"
                                            placeholder="Select Date"
                                            data-single="true"
                                            data-show-dropdown="true"
                                            value="{{ old('Voucher.expiryDate') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group date form_date">
                                        ...
                                        <input
                                            type="text"
                                            class="aiz-date-range form-control"
                                            name="Voucher[travelFromDate]"
                                            id="Voucher_travelFromDate"
                                            placeholder="Select Date"
                                            data-single="true"
                                            data-show-dropdown="true"
                                            value="{{ old('Voucher.travelFromDate') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="input-group date form_date">
                                        ...
                                        <input
                                            type="text"
                                            class="aiz-date-range form-control"
                                            name="Voucher[travelToDate]"
                                            id="Voucher_travelToDate"
                                            placeholder="Select Date"
                                            data-single="true"
                                            data-show-dropdown="true"
                                            value="{{ old('Voucher.travelToDate') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <select id="limit_selection" class="form-control" name="Voucher[redemptionLimit]" data-help="help_usage_limit">
                                            <option value="UNLIMITED" {{ old('Voucher.redemptionLimit') == 'UNLIMITED' ? 'selected' : '' }}>Unlimited</option>
                                            <option value="LIMITED" {{ old('Voucher.redemptionLimit') == 'LIMITED' ? 'selected' : '' }}>Limited</option>
                                        </select>
                                    </div>

                                    <div class="col-md-4 {{ old('Voucher.redemptionLimit') == 'LIMITED' ? '' : 'd-none' }}" id="limit_input">
                                        <input
                                            type="text"
                                            class="form-control @error('Voucher.maxUses') is-invalid @enderror"
                                            name="Voucher[maxUses]"
                                            id="Voucher_maxUses"
                                            placeholder="Enter limit"
                                            value="{{ old('Voucher.maxUses') }}"
                                            data-help="help_usage_limit"
                                        >
                                        @error('Voucher.maxUses')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                        <div class="invalid-feedback d-none" id="err_Voucher_maxUses">Please enter a valid integer limit.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group col-md-6 p-0">
                                    ...
                                    <input
                                        type="text"
                                        name="Voucher[minAmount]"
                                        id="Voucher_minAmount"
                                        class="form-control @error('Voucher.minAmount') is-invalid @enderror"
                                        placeholder="0.00"
                                        value="{{ old('Voucher.minAmount') }}"
                                        data-help="help_min_order"
                                    >
                                </div>
                                @error('Voucher.minAmount')
                                    <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="hidden" name="Voucher[includeTaxesAndFees]" value="0">
                                    <input type="checkbox" name="Voucher[includeTaxesAndFees]" value="1" {{ old('Voucher.includeTaxesAndFees', 1) ? 'checked' : '' }} data-help="help_taxes"> Include taxes & fees
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="hidden" name="Voucher[includeExtras]" value="0">
                                    <input type="checkbox" name="Voucher[includeExtras]" value="1" {{ old('Voucher.includeExtras', 1) ? 'checked' : '' }} data-help="help_extras"> Include extras
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="hidden" name="Voucher[internal]" value="0">
                                    <input type="checkbox" name="Voucher[internal]" value="1" {{ old('Voucher.internal') ? 'checked' : '' }} data-help="help_internal"> Hide code from customers
                                </label>
                            </div>
                            ...
                            <div class="card mt-4 p-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <select
                                            class="form-control @error('Voucher.valueType') is-invalid @enderror"
                                            name="Voucher[valueType]"
                                            id="Voucher_valueType"
                                            data-help="help_discount_type"
                                            required
                                        >
                                            <option value="">Select...</option>
                                            <option value="VALUE_LIMITPRODUCT" {{ old('Voucher.valueType') == 'VALUE_LIMITPRODUCT' ? 'selected' : '' }}>Fixed amount for one product</option>
                                            <option value="VALUE" {{ old('Voucher.valueType') == 'VALUE' ? 'selected' : '' }}>Fixed amount for any product</option>
                                            <option value="VALUE_LIMITCATALOG" {{ old('Voucher.valueType') == 'VALUE_LIMITCATALOG' ? 'selected' : '' }}>Fixed amount for category</option>
                                            <option value="PERCENT_LIMITPRODUCT" {{ old('Voucher.valueType') == 'PERCENT_LIMITPRODUCT' ? 'selected' : '' }}>% discount for one product</option>
                                            <option value="PERCENT" {{ old('Voucher.valueType') == 'PERCENT' ? 'selected' : '' }}>% discount for any product</option>
                                            <option value="PERCENT_LIMITCATALOG" {{ old('Voucher.valueType') == 'PERCENT_LIMITCATALOG' ? 'selected' : '' }}>% discount for category</option>
                                        </select>

                                        @error('Voucher.valueType')
                                            <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                        <div class="invalid-feedback d-none" id="err_Voucher_valueType">Please select a value type.</div>
                                ...
                                <div class="valueType valueType-VALUE row mt-3" style="display:none;">
                                    ...
                                    <div class="col-md-4 input-group">
                                        ...
                                        <input
                                            type="text"
                                            name="Voucher[voucherValue]"
                                            id="Voucher_voucherValue"
                                            class="form-control"
                                            value="{{ old('Voucher.voucherValue') }}"
                                ...
                                <div class="valueType valueType-PERCENT row mt-3" style="display:none;">
                                    ...
                                    <div class="col-md-4 input-group">
                                        <input
                                            type="text"
                                            name="Voucher[valuePercent]"
                                            id="Voucher_valuePercent"
                                            class="form-control"
                                            value="{{ old('Voucher.valuePercent') }}"
                                            data-help="help_discount_value"
                                        >
                                        <span class="input-group-text">%</span>
                                    </div>
                                ...
                                <div class="valueType valueType-CATALOG row mt-3" style="display:none;">
                                    ...
                                    <div class="col-md-6">
                                        <select name="Catalog[id]" id="Catalog_id" class="form-control" data-help="help_applicable_product">
                                            <option value="">Select...</option>
                            ...
                            <div class="form-group row mt-4">
                                <label for="Voucher_internalNotes" class="col-md-2 col-form-label">Internal Notes</label>
                                <div class="col-md-10">
                                    <textarea class="form-control" rows="5" name="Voucher[internalNotes]" id="Voucher_internalNotes" data-help="help_description">{{ old('Voucher.internalNotes') }}</textarea>
                                </div>
                            </div>
    ...
    $(document).ready(function () {
        ...
        function toggleLimitInput() {
            if ($('#limit_selection').val() === 'LIMITED') {
                ...
                $('#Voucher_maxUses').val('');
                $('#err_Voucher_maxUses').addClass('d-none');
            }
        }
        ...
        $('#Voucher_valueType').on('change', function () {
            var val = $(this).val();
        ...
        showValueTypeBlocks($('#Voucher_valueType').val());
        ...
        $('#promoForm').on('submit', function (e) {
            ...
            if (!$.trim($('#Voucher_code').val())) {
                valid = false;
                showFieldError('Voucher_code', 'Promo code is required.');
            } else {
                clearFieldError('Voucher_code');
            }

            // required: Voucher[valueType]
            if (!$.trim($('#Voucher_valueType').val())) {
                valid = false;
                showFieldError('Voucher_valueType', 'Please select a value type.');
            } else {
                clearFieldError('Voucher_valueType');
            }

            // if limited selected -> maxUses must be integer > 0
            if ($('#limit_selection').val() === 'LIMITED') {
                var maxUsesVal = $.trim($('#Voucher_maxUses').val());
                if (!maxUsesVal || !/^\d+$/.test(maxUsesVal) || parseInt(maxUsesVal) <= 0) {
                    valid = false;
                    showFieldError('Voucher_maxUses', 'Please enter a valid integer limit.');
                } else {
                    clearFieldError('Voucher_maxUses');
                }
            }

            // value-type specific checks
            var vt = $('#Voucher_valueType').val();
            if (vt) {
                if (vt.indexOf('VALUE') === 0) {
                    var voucherValue = $.trim($('#Voucher_voucherValue').val());
                    if (!voucherValue || !/^\d+(\.\d+)?$/.test(voucherValue)) {
                        valid = false;
                        showFieldError('Voucher_voucherValue', 'Enter a valid amount.');
                    } else {
                        clearFieldError('Voucher_voucherValue');
                    }
                }
                if (vt.indexOf('PERCENT') === 0) {
                    var percentVal = $.trim($('#Voucher_valuePercent').val());
                    if (!percentVal || !/^\d+(\.\d+)?$/.test(percentVal) || parseFloat(percentVal) <= 0) {
                        valid = false;
                        showFieldError('Voucher_valuePercent', 'Enter a valid percent (> 0).');
                    } else {
                        clearFieldError('Voucher_valuePercent');
                    }
                }
